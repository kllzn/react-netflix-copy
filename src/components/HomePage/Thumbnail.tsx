          ...
          <div className=" flex flex-col h-18 md:h-24 w-full items-center justify-between">
            ...
            <div className="flex gap-x-2 mt-2">
              <button
                ...
                className=" min-h-[10px] md:min-h-[20px] bg-white bg-opacity-80 text-black text-xs md:text-base font-medium px-1 md:px-2 rounded flex justify-center items-center gap-x-1">
